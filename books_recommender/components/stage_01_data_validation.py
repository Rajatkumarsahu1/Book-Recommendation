...
class DataValidation:
    ...
    def preprocess_data(self):
        try:
            ratings = pd.read_csv(self.data_validation_config.ratings_csv_file, delimiter=';',quotechar='"',encoding='ISO-8859-1',on_bad_lines='skip')
            books = pd.read_csv(self.data_validation_config.books_csv_file,delimiter=';',quotechar='"',encoding='ISO-8859-1',on_bad_lines='skip')
